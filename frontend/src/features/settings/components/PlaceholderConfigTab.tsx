  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-10 shadow-2xs text-center flex flex-col items-center justify-center space-y-3">
        <div className="w-14 h-14 rounded-2xl bg-[#013e37] text-[#ffefb3] flex items-center justify-center font-bold shadow-2xs">
          <Sliders className="w-7 h-7 text-[#ffefb3]" />
        </div>
        <h3 className="text-base font-bold text-[#013e37]">
