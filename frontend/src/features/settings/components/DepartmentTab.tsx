    ...
    <>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center p-20 border border-slate-200/80 rounded-2xl bg-white shadow-2xs space-y-3">
          <span className="w-8 h-8 border-3 border-[#013e37]/30 border-t-[#013e37] rounded-full animate-spin" />
        ...
        <div className="flex flex-col items-center justify-center p-16 border border-dashed border-slate-200 rounded-2xl bg-slate-50/50 text-center">
          ...
          {!searchQuery && (
            <button
              ...
              className="mt-3 inline-flex items-center gap-1 px-4 py-2 border border-[#013e37]/20 hover:bg-[#013e37]/10 text-[#013e37] text-xs font-bold rounded-xl transition-all cursor-pointer"
            >
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <button
                            ...
                            title="View Details"
                            className="p-1.5 hover:bg-slate-100 hover:text-[#013e37] text-slate-400 rounded-lg transition-colors cursor-pointer"
                          >
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
              <h3 className="text-sm font-bold text-[#013e37] uppercase tracking-wider flex items-center gap-1.5">
