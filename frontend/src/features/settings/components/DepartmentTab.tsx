        ...
        <div className="flex flex-col items-center justify-center p-16 border border-dashed border-slate-200 rounded-2xl bg-slate-50/50 text-center">
          ...
          {!searchQuery && (
            <button
              ...
              className="mt-3 inline-flex items-center gap-1 px-4 py-2 border border-indigo-200 hover:bg-indigo-50 text-indigo-600 text-xs font-bold rounded-xl transition-all cursor-pointer"
            >
