      ...
      <div>
        <div className="flex items-center gap-2 mb-3.5">
          <div className="w-7 h-7 rounded-lg bg-[#013e37]/10 flex items-center justify-center">
            <ClipboardList className="w-3.5 h-3.5 text-[#013e37]" />
          </div>
          <h3 className="font-bold text-[#013e37] text-xs sm:text-sm">Recent Activity</h3>
        </div>

        <div className="relative pl-3.5 border-l border-slate-100 space-y-3 text-left">
          <div className="relative">
            <span className="w-2 h-2 rounded-full bg-[#013e37] border-2 border-white absolute -left-[19px] top-1 shadow-2xs" />
